...
}:
{
  programs = {
    mangohud = {
      ...
      // (lib.mkIf (config.catppuccin.enable or false) (
        ...
        // (lib.mkIf (config.catppuccin.flavor == "latte") {
        ...
        // (lib.mkIf (config.catppuccin.flavor == "macchiato") {
        ...
        // (lib.mkIf (config.catppuccin.flavor == "mocha") {
